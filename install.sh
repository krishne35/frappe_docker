...
CUSTOM_TAG="15.0.1"
APPS_FILE="/home/ubuntu/data/frappe_docker/apps.json"
CONTAINERFILE="/home/ubuntu/data/frappe_docker/images/layered/Containerfile"
...
echo "✅  Done! Image: ${CUSTOM_IMAGE}:${CUSTOM_TAG}"
